...
define('exqui/tests/app.lint-test', [], function () {
  'use strict';
  ...
  QUnit.test('controllers/retries/show.js', function (assert) {
    assert.expect(1);
    assert.ok(true, 'controllers/retries/show.js should pass ESLint\n\n');
  });
  ...
  QUnit.test('routes/retries/show.js', function (assert) {
    assert.expect(1);
    assert.ok(true, 'routes/retries/show.js should pass ESLint\n\n');
  });
...
define('exqui/tests/tests.lint-test', [], function () {
  'use strict';
